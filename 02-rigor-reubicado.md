...
El resto de la guía es, en buena medida, un catálogo de dónde reubicar cada tipo de rigor: en guides explícitas (cap. 3), en sensors automáticos (cap. 3), en la arquitectura mecánicamente validada (cap. 7), en el contexto versionado del repo (cap. 6), en bucles de mantenimiento continuo (cap. 9). Ninguna de estas inversiones es opcional. Son los nuevos sitios donde el rigor tiene que vivir.
