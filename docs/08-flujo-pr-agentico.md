...
- **Identificar patrones que merecen subir al harness.** Si está corrigiendo lo mismo dos veces, eso no es revisión, es señal de que falta un guide o un sensor. Su trabajo más valioso es traducir esa observación en una mejora del harness.
